...
<div>
    <form name="form2" action="${pageContext.request.contextPath}/forum/evaluate/add" id="form15" method="post">
        <input type="hidden" value="${forum.forumid}" name="forumfk">
        <input type="hidden"  name="evaidfk" id="evaidFk">
        <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
               style="margin-top:8px">
            <tr bgcolor="#E7E7E7">
                <td height="24" colspan="2" background="${pageContext.request.contextPath}/images/bg2.gif">&nbsp;评论&nbsp;</td>
            </tr>
            <tr>
                <td align="right" bgcolor="#FAFAF1" height="22">
				<span>
					<img src='${pageContext.request.contextPath}/images/girl.jpg' height='50px' width='50px'/>
				</span>
               </td>
            ...
            <!-- 遍历我们的一级评论 -->
            <c:forEach items="${forum.evaluateList}" var="firsteval">
            <tr>
                <td align="right" bgcolor="#FAFAF1" height="22">
					<span>
						<img src='${pageContext.request.contextPath}/images/a.jpg' height='50px' width='50px'/>
					</span>
                </td>
                <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                    onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                    ...
                    &nbsp;<span><a href="javascript:setReplay(${firsteval.evaid});">【回复】</a></span>
                </td>
            </tr>
                <c:if test="${!empty firsteval.evaluateList}">
                    ...
                    <tr>
                        ...
                        <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                            ...
                            &nbsp;<span><a href="javascript:setReplay(${child.evaid});">【回复】</a></span>
            ...
            <tr bgcolor="#FAFAF1">
                <td height="28" colspan=4 align=center>
                    ...
                    <a href="${pageContext.request.contextPath}/main/main" class="coolbg">返回</a>
                </td>
            </tr>
