...
<script type="text/javascript">
    function login(){
      ...
      var password =  $("#password").val();
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/employees/checklogin",
            type:"post",
		...
		<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0 align="center">
			<TBODY>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16  name=username id=username value="zhangsan"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16  name=password id=password value="111111"></TD>
												</TR>
												<%--<TR>
				...
				<TR>
					...
					<TD colSpan=2><A><IMG title=关闭页面 height=48 alt="" src="${pageContext.request.contextPath}/images/crm_19.gif" width=84 border=0></A></TD>
					<TD><IMG height=48 alt="" src="${pageContext.request.contextPath}/images/crm_20.gif" width=101></TD>
				</TR>
				<TR>
					<TD colSpan=5 rowSpan=2><IMG height=132 alt="" src="${pageContext.request.contextPath}/images/crm_21.gif" width=292></TD>
