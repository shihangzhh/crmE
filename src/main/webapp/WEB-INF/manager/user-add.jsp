...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
	...
	<script type="application/javascript">
          $(function(){
              ...
              $.ajax({
                  type:'GET',
                  url:'${pageContext.request.contextPath}/employees/getPosition',
                  dataType:'json',
              ...
              $.ajax({
                  type:'GET',
                  url:'${pageContext.request.contextPath}/employees/getLevel',
                  dataType:'json',
                  success:function(resultData){
                      $(resultData).each(function(index,item){
              ...
              $.ajax({
                  type:'GET',
                  url:'${pageContext.request.contextPath}/employees/getDept',
                  dataType:'json',
                  success:function(resultData){
                      $(resultData).each(function(index,item){
                  ...
                  success:function(data){
                      if(data.status==200){
                          theAlert(data.msg,"alert",function(){
                              window.location="${pageContext.request.contextPath}/employees/user";
                          });
...
<form name="form2" action="${pageContext.request.contextPath}/employees/addEmp" method="post" id="form19">
