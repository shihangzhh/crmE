...
<tr>
 <td height="26" background="${pageContext.request.contextPath}/skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/employees/user-add';" value='添加用户' />
 </td>
 </tr>
</table>
</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${employee .eid}" class="np"></td>
	<td>${employee .eid}</td>
	...
	<td> <fmt:formatDate value="${employee .hiredate}" pattern="yyyy-MM-dd"></fmt:formatDate>  </td>
