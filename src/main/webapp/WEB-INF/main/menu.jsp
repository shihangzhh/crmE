...
<head>
<title>menu</title>
<link rel="stylesheet" href="/oa/skin/css/base.css" type="text/css" />
...
<base target="main" />
    <script type="text/javascript">
        ...
        $(function(){
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/employees/permission",
                dataType:"json",
                cache:false,
...
<li><a href='${pageContext.request.contextPath}/project/project-file' target='main'>附件管理</a> </li>
</ul>
</dd>
</dl>
...
<li><a href='${pageContext.request.contextPath}/task/task-add' target='main'>创建任务</a> </li>
<li><a href='${pageContext.request.contextPath}/task/taskInfor/task' target='main'>任务信息</a> </li>
<li><a href='${pageContext.request.contextPath}/task/taskInfor/task-my' target='main'>我的任务</a> </li>
<li><a href='${pageContext.request.contextPath}/notice/showNotices' target='main'>通知公告</a></li>
<li><a href='${pageContext.request.contextPath}/archives/myarchives' target='main'>我的档案</a> </li>
	<li><a href='${pageContext.request.contextPath}/archives/getAllArchives' target='main'>档案管理 </a> </li>
<li><a href='${pageContext.request.contextPath}/task/baoxiao/showDealBaoXiao' target='main'>报销审批</a> </li>
	<li><a href='${pageContext.request.contextPath}/task/baoxiao/getBaoXiaoTables' target='main'>我的报销</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/email/email' target='main'>我的邮箱</a> </li>
<li><a href='${pageContext.request.contextPath}/message/message-give' target='main'>消息推送</a> </li>
<li><a href='${pageContext.request.contextPath}/forum/show' target='main'>论坛</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/customer/forward/customer' target='main'>客户信息</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/employees/getAllEmployees' target='main'>人员管理</a> </li>
&lt;%&ndash;<li><a href='../manager/user.jsp' target='main'>部门管理</a> </li>&ndash;%&gt;
...
<dl class='bitem'><dt onclick=showHide("items7_1")><b>对标信息</b></dt><dd style='display:none' class='sitem' id=items7_1><ul class='sitemu' id=6>
	<li><a href='${pageContext.request.contextPath}/duibiao/duibiao-base' target='main'>对标信息管理</a></li>
<li><a href='${pageContext.request.contextPath}/duibiao/indexvalue-base' target='main'>设定指标</a></li>
<li><a href='${pageContext.request.contextPath}/duibiao/duibiao-result' target='main'>目标营业额分析</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/personInforPage' target='main'>信息查看</a> </li>
<li><a href='${pageContext.request.contextPath}/forwardModiPass' target='main'>修改密码</a> </li>
</ul></dd></dl>
 --%>
		</td>
		</tr>
