            ...
            <script type="text/javascript">
                ...
                $(function(){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/project/selectProject",
                        type:"get",
                        data:"",
                        dataType:"json",
                        cache:false,
                        success:function (data) {
                            $.each(data,function(index,element){
                                var tr="<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                                    ...
                                    "\t<td>进行中</td>\n" +
                                    "\t<td><a href=\"${pageContext.request.contextPath}/project/getProjectInfoByPid?pid="+element.pid+"\">编辑</a> | <a href=\"${pageContext.request.contextPath}/project/getProjectInfor?pid="+element.pid+"\">查看详情</a></td>\n" +
                                    "</tr>";
                                $("#showData").before(tr);
            ...
            <!--  搜索表单  -->
            <form id="projectForm" name='form3' action='' method='get'>
            ...
            <tr bgcolor="#E7E7E7">
                <td height="24" colspan="12" background="${pageContext.request.contextPath}/skin/images/frame/tbg.gif">&nbsp;项目信息列表&nbsp;</td>
            </tr>
