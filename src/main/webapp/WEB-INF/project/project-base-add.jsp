...
<script type="text/javascript">
	...
	$(function () {
       //查询客户信息
	    $.ajax({
			url:"${pageContext.request.contextPath}/customer/getAllCustomers",
			type:"post",
			dataType:"json",
			cache:false,
			success:function (data) {
			    ...
			    $.each(data,function (index,element) {
			        ...
			        var  option = "<option  companyperson='"+element.companyperson+"' value='"+element.id+"'>"+element.comname+"</option>";
        ...
        //项目经理
        $.ajax({
            url:"${pageContext.request.contextPath}/employees/position",
            type:"post",
	...
	function get_companyperson() {

	 var value =   $("#cuscompany option:selected").attr("companyperson");
	  /*  alert(value);*/
		$("#principal").val(value);
    }
    ...
    function commit() {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/project/saveProject",
            type:"post",
...
<form id="projectForm"  action="addPrimess.action" method="POST">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select  name="comname" id="cuscompany" onchange="get_companyperson();">
			<option>请选择---</option>
		</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="comper" id="principal"/>
	</td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF"  onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="starttime" id="starttime" onfocus="WdatePicker({el:'starttime'})" readonly="readonly"/>
	</td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">立项时间：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="buildtime" id="buildtime" onfocus="WdatePicker({el:'buildtime'})" readonly="readonly"/>
	</td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="endtime" id="endtime" onfocus="WdatePicker({el:'endtime'})" readonly="readonly"/>
	</td>
</tr>
