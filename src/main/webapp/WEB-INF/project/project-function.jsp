...
<tr>
 <td height="26" background="${pageContext.request.contextPath}/skin/images/frame/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/project/project-function-add';" value='添加新功能' />
 </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${pageContext.request.contextPath}/skin//images/frame/tbg.gif">&nbsp;功能列表&nbsp;</td>
</tr>
