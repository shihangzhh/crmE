...
<script type="text/javascript">
	...
	$(function () {
	    ...
	    //查询带有功能的项目
        $.ajax({
            url:"${pageContext.request.contextPath}/project/module/project",
            type:"post",
	...
	function saveFunction() {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/function/saveFunction",
            type:"post",
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="${pageContext.request.contextPath}/skin/images/frame/tbg.gif">&nbsp;添加新功能&nbsp;</td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">选择项目：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="proname" name="proname" onchange="selectAnalysis();"><option >请选择项目</option></select></td>
</tr>
<tr >
