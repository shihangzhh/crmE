...
<script type="application/javascript">
    ...
    function commit(){
        ...
        $("#archivesForm").ajaxSubmit(function(data){
            if(data.status==200) {
                alert(data.msg);
                window.location="${pageContext.request.contextPath}/archives/getAllArchives?currentPage=1";
            }else{
                alert(data.msg);
            }
...
<td height="28" colspan=4 align=center>
	...
	<a href="${pageContext.request.contextPath}/archives/getAllArchives?currentPage=1" class="coolbg">返回</a>
</td>
</tr>
</table>
</form>
