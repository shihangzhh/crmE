...
<script type="text/javascript">
	...
	function get_date(source){
	   ...
	   var month= format_date(date.getMonth()+1) ;
	   var day =  format_date(date.getDate());
	...
	function format_date(value){
        ...
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/employees/person/archives',
                dataType:'json',
        ...
        function fanhui() {
			window.top.location.href="${pageContext.request.contextPath}/main/index";
        }
...
<tr >
	...
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea type="text" rows=15 cols=130 id="remark" name="remark" readonly></textarea><span id="number"></span>
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	...
	<a href="javascript:fanhui();" class="coolbg">返回</a>
</td>
</tr>
</table>
